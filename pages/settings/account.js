...
const Account = () => {
	...
	return (
		<>
			<Navigation />
			<main
				className='md:mt-10 relative pb-32 mx-auto mt-8'
				style={{ maxWidth: "600px" }}
			>
				<div className='bg-primary-background bg-opacity-90 blur-bg sticky top-0 z-20 flex justify-between px-6 py-5 mb-12'>
					<div className='flex items-center'>
						...
						<h1 className='ml-4 text-3xl font-bold'>My Account</h1>
					</div>
					<CollectionDropdown />
				</div>
